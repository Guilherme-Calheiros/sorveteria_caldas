...
export default function CardEmbalagem({embalagem, onEditar, onExcluir}) {
    ...
    return(
        <div key={embalagem.id} className="rounded-xl bg-white col-span-1 border-l-4 border-primary p-4 shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col gap-3">
